...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Laravel eCom | Single</title> 
         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <a href="{{ route('category', [$cat->id, $cat->category_slug]) }}">{{ $cat->category_name }}</a>
                  @endforeach
                  </div>
                  ...
                  <div class="dropdown">
                     ...
                     @foreach ($categories as $cat)
                     <a  class="dropdown-item" href="{{ route('category', [$cat->id, $cat->category_slug]) }}">{{ $cat->category_name }}</a>
                  ...
                  <div class="header_box">
                     ...
                     <div class="login_menu">
                      ...
                      if($id !=''){    
                        echo '<li><a href="/user-profile">
                              <i class="fa fa-user" aria-hidden="true"></i>
                              <span class="padding_10">'.$username.'</span></a>
                           </li>';
                      }
                  @endphp --}}
...
.banner_bg_main {
    ...
    height: 20rem;
      ...
      {{-- common part start --}}
      <div class="content py-5" style="margin-top:200px;">
         @yield('main-content')
      </div>
