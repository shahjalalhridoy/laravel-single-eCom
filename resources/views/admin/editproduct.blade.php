                    ...
                    <form action="{{ route('updateproduct') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control"  placeholder="Price" readonly value="{{ $productInfo->product_category_name }}"/>
                              </div>
                          </div>
                          ...
                          <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control"  placeholder="Price" readonly value="{{ $productInfo->product_sub_category_name }}"/>
                              </div>
                          </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="product_name"
                                        name="product_name" placeholder="Product Name" value="{{ $productInfo->product_name }}"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                  <input type="number" class="form-control" id="product_price"
                                      name="product_price" placeholder="Price" value="{{ $productInfo->product_price }}"/>
                              </div>
                          </div>
                          ...
                          <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                ...
                                >
                                {{ $productInfo->product_short_desc }}
                              </textarea>
                              </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="product_qty"
                                        name="product_qty" placeholder="Quantity" value="{{ $productInfo->product_qty }}"/>
                                </div>
                            </div>
